...
var fight = function(enemyName) {
    while (playerHealth > 0 && enemyHealth > 0) {
        ...
        if (promptFight === "skip" || promptFight === "SKIP") {
            ...
            console.log(playerName + ' attacked ' + enemyName + ' for ' + damage + '. ' + enemyName + ' now has ' + enemyHealth + ' health remaining.');
            ...
            console.log(enemyName + ' attacked ' + playerName + ' for ' + damage + ". " + playerName + ' now has ' + playerHealth + ' health remaining.');
    ...
    for(var i= 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            if (i < enemyNames.length -1 && playerHealth > 0) {
                ...
                window.alert(pickedEnemyName + " has defeated your robot.");
                break;
            };
        };
    };
